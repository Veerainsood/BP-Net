...
def load_depth_input(calib, image, points):
    #Loads the image as rgb + construct its lidar 2d depth image and return
...
def depth2pointsrgbp(depth, image, calib, lidar):
    ...
    new_p = new_p[new_p[:, 2] < 1.] # Sensor is mounted above the car in kitti velo so this measures 
    # the height above the sensor... we will discard too big cars to be classified as trucks...
